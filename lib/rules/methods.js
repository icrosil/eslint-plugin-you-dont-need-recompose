...
// TODO: get rid of array functions or switch to them? caniuseit
...
const customErrorMethods = [
  ...
  { method: 'pure', message: funcMessage('React.memo') },
  { method: 'onlyUpdateForKeys', message: funcMessage('React.memo') },
  { method: 'onlyUpdateForPropTypes', message: funcMessage('React.memo') },
  ...
  { method: 'withReducer', message: hookMessage('useReducer') },
  {
